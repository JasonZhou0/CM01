...
#define USE_Delay//此处使用STM32以太网库自带delay

#ifdef USE_Delay
  #include "delay.h"                /* Header file where the Delay function prototype is exported */  
...
//#define PHY_SR                 ((uint16_t)16)     /* DP83848 PHY status register Offset */
//#define PHY_SPEED_STATUS       ((uint16_t)0x0002) /* DP83848 PHY Speed mask */
//#define PHY_DUPLEX_STATUS      ((uint16_t)0x0004) /* DP83848 PHY Duplex mask */
     
#define PHY_SR                 ((uint16_t)31)     /* LAN8720 PHY status register Offset 状态寄存器地址*/  
#define PHY_SPEED_STATUS       ((uint16_t)0x0004) /* LAN8720 PHY Speed mask 速度*/
#define PHY_DUPLEX_STATUS      ((uint16_t)0x00010)/* LAN8720 PHY Duplex mask 连接状态*/  
