...
#ifdef QAC
/*! \qacexception 1056: The keyword '_Bool' has been used. MISRA-C:2004 Rule 1.1; REFERENCE - ISO:C99-6.2.5 Types
 *                      Keyword _Bool is used when running QAC analysis to get better understanding of boolean
 *                      expressions from the PRQA tool. It is never used in the production code.
 */
typedef _Bool              AlvBool; /*    AlvFalse .. AlvTrue         */ /* PRQA S 1056 */
#else
